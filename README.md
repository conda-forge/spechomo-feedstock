...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spechomo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10893&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spechomo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spechomo` can be installed with:

```
conda install spechomo
```

It is possible to list all of the versions of `spechomo` available on your platform with:
